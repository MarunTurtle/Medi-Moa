...
scraper_modules = {
    "KOPS 공지사항": "scrapers.1_test_KOPS_NOTICE",
    "KOPS 발령": "scrapers.2_test_KOPS_ALARM",
    "KOPS 정보제공지": "scrapers.3_test_KOPS_INFO",
    "대한병원협회 공지사항": "scrapers.4_test_KHA_NOTICE",
    "대한환자안전학회 공지사항": "scrapers.5_test_KSPS_NOTICE",
    "한국의료질향상학회 공지사항": "scrapers.6_test_KOSQUA_NOTICE",
    "지역환자안전센터 공지사항": "scrapers.7_test_KNAPS_NOTICE",
    "지역환자안전센터 소식지": "scrapers.8_test_KNAPS_NEWS",
    "지역환자안전센터 교육행사": "scrapers.9_test_KNAPS_PROMOTION",
    "대한병원협회교육 공지사항": "scrapers.10_test_KHAEDU_NOTICE",
    "정신간호사회 공지사항": "scrapers.11_test_KPMHNA_NOTICE",
    "정신간호사회 자료실": "scrapers.12_test_KPMHNA_DATA",
    "의료&복지 뉴스": "scrapers.13_test_MEDI_NEWS",
    "질병관리청 공지사항": "scrapers.14_test_KDCA_NOTICE",
    "질병관리청 보도자료": "scrapers.15_test_KDCA_NEWS"
}
