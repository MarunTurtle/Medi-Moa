    ...
    try:
        ...
        for row in rows:
            try:
                ...
                if number_elem:
                    if number_elem.find('i', class_='bd_notice'):
                        number = '공지'
                    else:
...
# Save to CSV
df.to_csv("scraped_10_kpmhna_notice.csv", index=False, encoding='utf-8-sig')
print("Data saved to scraped_10_kpmhna_notice.csv") 