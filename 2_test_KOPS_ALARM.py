...
# Base URL of the KOPS_ALARM site
base_url = "https://www.kops.or.kr/portal/aam/atent/atentAlarmCntrmsrList.do"
    ...
    try:
        ...
        for row in rows:
            try:
                ...
                # Just use the main alarm board URL
                detail_url = base_url
                ...
                date = row.select_one('td:nth-child(4)').text.strip().rstrip('.')
